...
class UsuarioModel
{
    ...
    public function Buscar($dato)
    {
        $sql = "SELECT 
                ...
                WHERE u.vigencia = 1 
                    ...
                    OR u.usu_usuario LIKE ? 
                    OR u.email_usuario LIKE ? 
                    OR u.tel_usuario LIKE ? 
                    OR p.nom_perfil LIKE ?);";
        $dato = "%{$dato}%";
    ...
    public function Mostrar($id)
    {
        $sql = "SELECT 
                    ...
                    u.nom_usuario AS nomUsuario, 
                    u.tel_usuario AS telUsuario, 
                    u.email_usuario AS emailUsuario, 
                    u.dir_usuario AS dirUsuario, 
                    u.usu_usuario AS usuUsuario, 
